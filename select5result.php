...
if ($result->num_rows > 0){
    ...
    echo '<th>title</th><th>director</th>';
    echo '</tr>';
    }
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo '<tr>';
        echo  '<td>'. $row["title"].'<td>'. $row["director"].'</td>'. '</td>';
    }
    echo '</table>';
} else {
    echo '<br>';
...
To get some detail about the director <br/> <br/>

<meta http-equiv="content-type" content="text/html;charset=utf-8"/> 
<form action="select5d.php" method="post">
directorname         : <input type="text" name="name"/><br/>
