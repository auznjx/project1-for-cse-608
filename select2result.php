<input type="button" value="back" onclick="window.location.href='select2.php'"/>
...
select starsinmovie.title
from starsinmovie
where
 (star1 like '%$_POST[star1]%'
 and star2 like '%$_POST[star2]%')
 or
 (star2 like '%$_POST[star1]%'
 and star1 like '%$_POST[star2]%')
