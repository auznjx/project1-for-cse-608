...
if ($result->num_rows > 0){
    ...
    echo '<th>directorname</th><th>directorborndate</th><th>directorbornplace</th>';
    echo '</tr>';
    }
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo '<tr>';
        echo  '<td>'. $row["directorname"].'<td>'. $row["directorborndate"].'</td>'.  '<td>'. $row["directorbornplace"].'</td>'.'</td>';
    }
    echo '</table>';
} else {
    echo '<br>';
